 ...
 * Rendering is frozen as of the 2026-09-03 rig captures (reference/d3d):
 * d3dx9_33+ HLSL compilers reject ps_1_1 (X3539), so on the rig the cubes
 * ran vs_1_1 with the fixed-function pixel stage. Do not "fix" this (e.g.
 * by assembling ps_1_1) without a new golden set. */
...
static void make_shaders(void)
{
     ...
     * pixel stage is a legal D3D9 combination and what the rig ran */
