...
D3DPT\    D3D9.DLL D3D9TEST.EXE D3DGAME9.EXE D3DFEAT9.EXE   → paravirtual Direct3D 9 (our device, doc 14): D3D9.DLL next to the game's EXE; needs FXPTL.SYS / FXMEMMAP.VXD like OPENGL32.DLL. Never together with WINED3D's D3D9.DLL. Log in d3dpt.log next to the EXE (C:\d3dpt.log from the CD)
```
