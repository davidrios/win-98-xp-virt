...
6. **M6** → `docs/tracks/m6-launcher.md` (opened 2026-09-04: toolkit decided; bundle format, library grid and spawning a player landed, verified with a real player boot; next is the guided creation wizard).
