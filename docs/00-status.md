...
6. **M6** → `docs/tracks/m6-launcher.md` (opened 2026-09-04: toolkit decided, skeleton window; next is the `machine.toml` bundle format, then the library grid).
