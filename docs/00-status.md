...
4. **M5** → `docs/tracks/m5-cdrom-backend.md` (steps 1–7 done; step 8 has SafeDisc 2.x and plain mixed-mode + CD-DA green as of 2026-09-05, ProtectCD/Settlers 3 next and the FIFA 2002 no-match to triage; M5e MDS done early, CHD open); M6 launcher.
