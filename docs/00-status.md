...
real-world number); **M7** → `docs/tracks/m7-display-driver.md` (a DX7
game on the M7c HAL, a driver stage in `scripts/test.sh`, cursor / vblank
/ mode table). ADR-008 (2026-09-04): the M7 driver is the long-term XP shape; the
