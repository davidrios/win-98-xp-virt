...
| `tools/xp-moto-race.sh <image> <name> [qemu]` | Moto Racer 1997 into a practice race headless (demo → title → Solo → Practice → Start over QMP, throttle held) and its fps; the M9 track's game oracle |
